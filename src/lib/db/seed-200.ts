...
const ORGANIZATIONS: PunditSeed[] = [
  ...
  { id: "breitbart", name: "Breitbart News", slug: "breitbart", platforms: ["other"], currentLeaning: "right", description: "Right-wing digital news outlet founded by Andrew Breitbart. Key MAGA media organ; Steve Bannon was executive chairman.", knownFor: ["Breitbart News"], tags: ["digital", "organization", "conservative", "mainstream-media"] },
