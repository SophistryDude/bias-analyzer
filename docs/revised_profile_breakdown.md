...
| Pre-libertarian | Right-coded positions without conservative identity | Per Q16, held some positions aligned with conservatives but disagreed with enough of them that he did not identify with the label. Subject has explicitly stated (April 2026) "I don't think I've ever been considered conservative" — the Q16 self-description as "was a conservative" was loose phrasing and should not be taken as an identity label. Functional description: held some right-coded policy positions during this period without being identified as a conservative by self or others. |
| Libertarian | Libertarian | Shifted to libertarianism after disagreeing with the positions he had previously held. Duration not specified. |
